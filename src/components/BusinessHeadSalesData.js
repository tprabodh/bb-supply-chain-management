...
const BusinessHeadSalesData = ({ cityOperationsHeadId }) => {
  ...
  useEffect(() => {
    ...
    const setupSubscriptions = () => {
      setLoading(true);
      try {
        zonalHeadsUnsubscribe = subscribeToZonalHeadsByCityOperationsHead(cityOperationsHeadId, (zonalHeads) => {
...
export default BusinessHeadSalesData;
